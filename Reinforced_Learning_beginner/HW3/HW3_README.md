...
## Финальные выводы.
Алгоритм SAC с использованием максимизации энтропии при использовании оптимального коэффициента тепмературы показывает лучшие результаты, чем просто обучение на максимизацию вознаграждение. Использование автоподбора коэффициента позволит быстро достичь оптимальных результатов.
